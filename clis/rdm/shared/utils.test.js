...
describe('rdm shared utils', () => {
  ...
  it('formats issue detail payload into stable output', () => {
    const result = buildIssueDetailResult({
      ...
      comments: [{ createdAt: '2026-04-01', authorName: '王五', content: '<p>评论内容</p>' }],
      workLogs: [{ createdAt: '2026-04-02', authorName: '赵六', duration: 8 }],
      dataLogs: [{ createdAt: '2026-04-03', authorName: '孙七', fieldName: '状态', oldString: '待处理', newString: '处理中' }],
    });
